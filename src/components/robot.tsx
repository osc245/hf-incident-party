...
export function Robot({
  ...
  return (
    ...
    >
      ...
      <span className="absolute top-[55px] left-[2px] z-[2] h-[31px] w-[17px] rounded-[8px_2px_2px_8px] robot-part" />
      <span className="absolute top-[34px] left-4 z-[3] block h-[72px] w-[94px] rounded-[23px_23px_18px_18px] robot-part">
        <span className="absolute inset-[14px_12px_13px] block overflow-hidden rounded-[14px] border-2 border-outline bg-robot-screen after:absolute after:top-[-6px] after:left-[-11px] after:h-[55px] after:w-10 after:rotate-20 after:bg-white/35 after:content-['']">
          <i className="robot-eye left-[15px]" />
          <i className="robot-eye right-[15px]" />
          <i className="absolute bottom-[9px] left-1/2 h-1.5 w-[19px] -translate-x-1/2 rounded-full border-b-2 border-outline" />
        </span>
      </span>
      <span className="absolute top-[102px] left-[50px] z-[1] h-[17px] w-[26px] robot-part" />
      <span className="absolute top-[113px] left-[27px] z-[2] block h-[50px] w-[72px] rounded-[9px_9px_18px_18px] robot-part">
      ...
      <span className="absolute top-[122px] left-[14px] z-[1] h-[41px] w-[19px] origin-top rotate-[18deg] rounded-lg robot-part" />
      <span
        className={[
